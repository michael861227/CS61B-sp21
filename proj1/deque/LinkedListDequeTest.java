...
public class LinkedListDequeTest {
    ...
    public void getTest() {
        ...
        assertEquals("Should have the same value", 10, (double)lld1.get(0), 0.0);
        assertEquals("Should have the same value", 1, (double)lld1.get(2), 0.0);
        assertNull("The value should be null", lld1.get(3));
        assertNull("The value should be null", lld1.get(-2));

        /** Test for getRecursive method */
        assertEquals("Should have the same value", 10, (double)lld1.getRecursive(0), 0.0);
        assertEquals("Should have the same value", 1, (double)lld1.getRecursive(2), 0.0);
